    ...
    claude: `// claude_desktop_config.json
{
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Setup steps + terminal preview */}
      <div className="grid lg:grid-cols-2 gap-8">
        {/* Left: Steps */}
        <div className="space-y-4">
          <h2 className="text-lg font-semibold">{t('setupSteps')}</h2>
            ...
            <CardContent className="pb-5">
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <span
                    key={tool}
                    className="inline-flex items-center rounded-lg bg-muted px-2.5 py-1 text-xs font-mono text-muted-foreground"
                  >
                    {tool}
                  </span>
                ))}
